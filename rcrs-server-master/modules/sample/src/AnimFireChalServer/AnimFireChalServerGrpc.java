...
public final class AnimFireChalServerGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<AnimFireChalServerProto.Empty,
      AnimFireChalServerProto.BuildingInfo> getGetBuildingInfoMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "getBuildingInfo",
      requestType = AnimFireChalServerProto.Empty.class,
      responseType = AnimFireChalServerProto.BuildingInfo.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<AnimFireChalServerProto.Empty,
      AnimFireChalServerProto.BuildingInfo> getGetBuildingInfoMethod() {
    io.grpc.MethodDescriptor<AnimFireChalServerProto.Empty, AnimFireChalServerProto.BuildingInfo> getGetBuildingInfoMethod;
      ...
      synchronized (AnimFireChalServerGrpc.class) {
        if ((getGetBuildingInfoMethod = AnimFireChalServerGrpc.getGetBuildingInfoMethod) == null) {
          AnimFireChalServerGrpc.getGetBuildingInfoMethod = getGetBuildingInfoMethod =
              io.grpc.MethodDescriptor.<AnimFireChalServerProto.Empty, AnimFireChalServerProto.BuildingInfo>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "getBuildingInfo"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  AnimFireChalServerProto.Empty.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  AnimFireChalServerProto.BuildingInfo.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<AnimFireChalServerProto.Empty,
      AnimFireChalServerProto.Reward> getGetRewardMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "getReward",
      requestType = AnimFireChalServerProto.Empty.class,
      responseType = AnimFireChalServerProto.Reward.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<AnimFireChalServerProto.Empty,
      AnimFireChalServerProto.Reward> getGetRewardMethod() {
    io.grpc.MethodDescriptor<AnimFireChalServerProto.Empty, AnimFireChalServerProto.Reward> getGetRewardMethod;
      ...
      synchronized (AnimFireChalServerGrpc.class) {
        if ((getGetRewardMethod = AnimFireChalServerGrpc.getGetRewardMethod) == null) {
          AnimFireChalServerGrpc.getGetRewardMethod = getGetRewardMethod =
              io.grpc.MethodDescriptor.<AnimFireChalServerProto.Empty, AnimFireChalServerProto.Reward>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              ...
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  AnimFireChalServerProto.Empty.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  AnimFireChalServerProto.Reward.getDefaultInstance()))
  ...
  public static abstract class AnimFireChalServerImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void getBuildingInfo(AnimFireChalServerProto.Empty request,
        io.grpc.stub.StreamObserver<AnimFireChalServerProto.BuildingInfo> responseObserver) {
      asyncUnimplementedUnaryCall(getGetBuildingInfoMethod(), responseObserver);
    }

    /**
     */
    public void getReward(AnimFireChalServerProto.Empty request,
        io.grpc.stub.StreamObserver<AnimFireChalServerProto.Reward> responseObserver) {
    ...
    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                AnimFireChalServerProto.Empty,
                AnimFireChalServerProto.BuildingInfo>(
          ...
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                AnimFireChalServerProto.Empty,
                AnimFireChalServerProto.Reward>(
  ...
  public static final class AnimFireChalServerBlockingStub extends io.grpc.stub.AbstractStub<AnimFireChalServerBlockingStub> {
    ...
    /**
     */
    public AnimFireChalServerProto.BuildingInfo getBuildingInfo(AnimFireChalServerProto.Empty request) {
    ...
    /**
     */
    public AnimFireChalServerProto.Reward getReward(AnimFireChalServerProto.Empty request) {
      return blockingUnaryCall(
  ...
  public static final class AnimFireChalServerFutureStub extends io.grpc.stub.AbstractStub<AnimFireChalServerFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<AnimFireChalServerProto.BuildingInfo> getBuildingInfo(
        AnimFireChalServerProto.Empty request) {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<AnimFireChalServerProto.Reward> getReward(
        AnimFireChalServerProto.Empty request) {
      return futureUnaryCall(
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_GET_BUILDING_INFO:
          serviceImpl.getBuildingInfo((AnimFireChalServerProto.Empty) request,
              (io.grpc.stub.StreamObserver<AnimFireChalServerProto.BuildingInfo>) responseObserver);
          break;
        case METHODID_GET_REWARD:
          serviceImpl.getReward((AnimFireChalServerProto.Empty) request,
              (io.grpc.stub.StreamObserver<AnimFireChalServerProto.Reward>) responseObserver);
          break;
        default:
  ...
  private static abstract class AnimFireChalServerBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return AnimFireChalServerProto.getDescriptor();
    }
